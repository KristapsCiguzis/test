...
#Norādu savu nasa api kodu ko var iegūt no NASA mājas kapas
nasa_api_key = "MGr2PJFZImV70xFFZ3SBdEUsZo8s16ubstc0vBWt"
...
#Sāk arrays priekš drošiem un bīstamiem ast.
	ast_safe = []
	ast_hazardous = []
		...
		if ast_count > 0:
			for val in json_data['near_earth_objects'][request_date]:
				if 'name' and 'nasa_jpl_url' and 'estimated_diameter' and 'is_potentially_hazardous_asteroid' and 'close_approach_data' in val:
					#Iegūst asteroid nosaukumu
					tmp_ast_name = val['name']
					#Iegūs informāciju par asteroid aprakstu no nasa api
					tmp_ast_nasa_jpl_url = val['nasa_jpl_url']
					#Iegūst informāciju par astroid izmēriem
